  ...
  return (
    <button
      className={cn(
        ...
        {
          'bg-secondary group-hover:text-black dark:group-hover:text-white':
    ...
    >
      ...
      />
      <p className='font-semibold ml-4 text-muted-foreground group-hover:text-black dark:group-hover:text-white '>
        {member.profile?.name}
      </p>
